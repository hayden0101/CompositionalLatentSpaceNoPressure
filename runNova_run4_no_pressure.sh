...
#SBATCH --job-name="cls-r4-nop"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run4_no_pressure_%j.out"
#SBATCH --error="run4_no_pressure_%j.err"
...
CONFIG="configs/compositional/run4_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run4-no-pressure"
OUTDIR="docs/figures/run4_no_pressure"
...
echo "Training Run 4 without pressure using $CONFIG"
...
echo "Run 4 complete. Checkpoint: $CHECKPOINT"
echo "Figures: $OUTDIR"
