...
#SBATCH --job-name="cls-r6-nop"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run6_no_pressure_%j.out"
#SBATCH --error="run6_no_pressure_%j.err"
...
CONFIG="configs/compositional/run6_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run6-no-pressure"
OUTDIR="docs/figures/run6_no_pressure"
...
echo "Training Run 6 without pressure using $CONFIG"
...
echo "Run 6 complete. Checkpoint: $CHECKPOINT"
echo "Figures: $OUTDIR"
