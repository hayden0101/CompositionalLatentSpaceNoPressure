...
#SBATCH --job-name="cls-r10"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run10_no_pressure_%j.out"
#SBATCH --error="run10_no_pressure_%j.err"
...
CHECKPOINT_ROOT="checkpoints/compositional-run10-no-pressure"
...
echo "Training Run 10 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 10 complete. Checkpoint: $CHECKPOINT"
