...
#SBATCH --job-name="cls-r27"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run27_no_pressure_%j.out"
#SBATCH --error="run27_no_pressure_%j.err"
...
CONFIG="configs/compositional/run27_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run27-no-pressure"
OUTDIR="docs/figures/run27_no_pressure"
...
echo "Training Run 27 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 27 complete. Checkpoint: $CHECKPOINT"
