...
#SBATCH --job-name="cls-r26"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run26_no_pressure_%j.out"
#SBATCH --error="run26_no_pressure_%j.err"
...
CONFIG="configs/compositional/run26_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run26-no-pressure"
OUTDIR="docs/figures/run26_no_pressure"
...
echo "Training Run 26 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 26 complete. Checkpoint: $CHECKPOINT"
