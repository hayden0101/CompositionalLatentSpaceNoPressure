...
#SBATCH --job-name="cls-r22"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run22_no_pressure_%j.out"
#SBATCH --error="run22_no_pressure_%j.err"
...
CONFIG="configs/compositional/run22_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run22-no-pressure"
OUTDIR="docs/figures/run22_no_pressure"
...
echo "Training Run 22 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 22 complete. Checkpoint: $CHECKPOINT"
