...
#SBATCH --job-name="cls-r17"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run17_no_pressure_%j.out"
#SBATCH --error="run17_no_pressure_%j.err"
...
CONFIG="configs/compositional/run17_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run17-no-pressure"
OUTDIR="docs/figures/run17_no_pressure"
...
echo "Training Run 17 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Running probes and standard swap diagnostics from $CHECKPOINT"
...
echo "Run 17 complete. Checkpoint: $CHECKPOINT"
