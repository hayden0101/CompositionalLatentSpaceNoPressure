...
#SBATCH --job-name="cls-r14"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run14_no_pressure_%j.out"
#SBATCH --error="run14_no_pressure_%j.err"
...
CONFIG="configs/compositional/run14_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run14-no-pressure"
OUTDIR="docs/figures/run14_no_pressure"
...
echo "Training Run 14 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 14 complete. Checkpoint: $CHECKPOINT"
