...
#SBATCH --job-name="cls-r12"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run12_no_pressure_%j.out"
#SBATCH --error="run12_no_pressure_%j.err"
...
CONFIG="configs/compositional/run12_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run12-no-pressure"
OUTDIR="docs/figures/run12_no_pressure"
...
echo "Training Run 12 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 12 complete. Checkpoint: $CHECKPOINT"
