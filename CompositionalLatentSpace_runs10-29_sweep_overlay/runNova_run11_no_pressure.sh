...
#SBATCH --job-name="cls-r11"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run11_no_pressure_%j.out"
#SBATCH --error="run11_no_pressure_%j.err"
...
CONFIG="configs/compositional/run11_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run11-no-pressure"
OUTDIR="docs/figures/run11_no_pressure"
...
echo "Training Run 11 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 11 complete. Checkpoint: $CHECKPOINT"
