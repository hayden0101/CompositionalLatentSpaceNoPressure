...
#SBATCH --job-name="cls-r24"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run24_no_pressure_%j.out"
#SBATCH --error="run24_no_pressure_%j.err"
...
CONFIG="configs/compositional/run24_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run24-no-pressure"
OUTDIR="docs/figures/run24_no_pressure"
...
echo "Training Run 24 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 24 complete. Checkpoint: $CHECKPOINT"
