...
#SBATCH --job-name="cls-r23"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run23_no_pressure_%j.out"
#SBATCH --error="run23_no_pressure_%j.err"
...
CONFIG="configs/compositional/run23_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run23-no-pressure"
OUTDIR="docs/figures/run23_no_pressure"
...
echo "Training Run 23 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 23 complete. Checkpoint: $CHECKPOINT"
