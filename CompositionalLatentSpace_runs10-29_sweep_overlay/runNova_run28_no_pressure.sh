...
#SBATCH --job-name="cls-r28"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run28_no_pressure_%j.out"
#SBATCH --error="run28_no_pressure_%j.err"
...
CONFIG="configs/compositional/run28_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run28-no-pressure"
OUTDIR="docs/figures/run28_no_pressure"
...
echo "Training Run 28 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 28 complete. Checkpoint: $CHECKPOINT"
