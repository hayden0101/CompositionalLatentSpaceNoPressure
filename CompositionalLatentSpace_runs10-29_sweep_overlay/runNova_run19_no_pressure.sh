...
#SBATCH --job-name="cls-r19"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run19_no_pressure_%j.out"
#SBATCH --error="run19_no_pressure_%j.err"
...
CONFIG="configs/compositional/run19_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run19-no-pressure"
OUTDIR="docs/figures/run19_no_pressure"
...
echo "Training Run 19 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 19 complete. Checkpoint: $CHECKPOINT"
