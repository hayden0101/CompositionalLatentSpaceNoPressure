...
#SBATCH --job-name="cls-r20"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run20_no_pressure_%j.out"
#SBATCH --error="run20_no_pressure_%j.err"
...
CONFIG="configs/compositional/run20_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run20-no-pressure"
OUTDIR="docs/figures/run20_no_pressure"
...
echo "Training Run 20 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 20 complete. Checkpoint: $CHECKPOINT"
