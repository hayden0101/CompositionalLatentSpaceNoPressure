...
#SBATCH --job-name="cls-r13"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run13_no_pressure_%j.out"
#SBATCH --error="run13_no_pressure_%j.err"
...
CONFIG="configs/compositional/run13_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run13-no-pressure"
OUTDIR="docs/figures/run13_no_pressure"
...
echo "Training Run 13 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 13 complete. Checkpoint: $CHECKPOINT"
