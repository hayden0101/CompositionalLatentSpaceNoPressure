...
#SBATCH --job-name="cls-r18"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run18_no_pressure_%j.out"
#SBATCH --error="run18_no_pressure_%j.err"
...
CONFIG="configs/compositional/run18_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run18-no-pressure"
OUTDIR="docs/figures/run18_no_pressure"
...
echo "Training Run 18 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 18 complete. Checkpoint: $CHECKPOINT"
