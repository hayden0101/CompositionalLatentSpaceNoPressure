...
#SBATCH --job-name="cls-r29"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run29_no_pressure_%j.out"
#SBATCH --error="run29_no_pressure_%j.err"
...
CONFIG="configs/compositional/run29_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run29-no-pressure"
OUTDIR="docs/figures/run29_no_pressure"
...
echo "Training Run 29 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 29 complete. Checkpoint: $CHECKPOINT"
