...
#SBATCH --job-name="cls-r21"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run21_no_pressure_%j.out"
#SBATCH --error="run21_no_pressure_%j.err"
...
CONFIG="configs/compositional/run21_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run21-no-pressure"
OUTDIR="docs/figures/run21_no_pressure"
...
echo "Training Run 21 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 21 complete. Checkpoint: $CHECKPOINT"
