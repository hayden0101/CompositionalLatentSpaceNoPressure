...
#SBATCH --job-name="cls-r25"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run25_no_pressure_%j.out"
#SBATCH --error="run25_no_pressure_%j.err"
...
CONFIG="configs/compositional/run25_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run25-no-pressure"
OUTDIR="docs/figures/run25_no_pressure"
...
echo "Training Run 25 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 25 complete. Checkpoint: $CHECKPOINT"
