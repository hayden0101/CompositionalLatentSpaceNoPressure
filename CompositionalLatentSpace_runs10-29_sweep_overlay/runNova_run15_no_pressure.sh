...
#SBATCH --job-name="cls-r15"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run15_no_pressure_%j.out"
#SBATCH --error="run15_no_pressure_%j.err"
...
CONFIG="configs/compositional/run15_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run15-no-pressure"
OUTDIR="docs/figures/run15_no_pressure"
...
echo "Training Run 15 one-factor full-swap candidate without pressure using $CONFIG"
...
echo "Run 15 complete. Checkpoint: $CHECKPOINT"
