...
#SBATCH --job-name="cls-r2-nop"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run2_no_pressure_%j.out"
#SBATCH --error="run2_no_pressure_%j.err"
...
CONFIG="configs/compositional/run2_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run2-no-pressure"
OUTDIR="docs/figures/run2_no_pressure"
...
echo "Training Run 2 without pressure using $CONFIG"
...
echo "Run 2 complete. Checkpoint: $CHECKPOINT"
echo "Figures: $OUTDIR"
