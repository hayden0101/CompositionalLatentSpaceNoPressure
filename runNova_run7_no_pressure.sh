...
#SBATCH --job-name="cls-r7-nop"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run7_no_pressure_%j.out"
#SBATCH --error="run7_no_pressure_%j.err"
...
CONFIG="configs/compositional/run7_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run7-no-pressure"
OUTDIR="docs/figures/run7_no_pressure"
...
echo "Training Run 7 without pressure using $CONFIG"
...
echo "Run 7 complete. Checkpoint: $CHECKPOINT"
echo "Figures: $OUTDIR"
