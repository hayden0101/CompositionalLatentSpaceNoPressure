...
#SBATCH --job-name="cls-r1-nop"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run1_no_pressure_%j.out"
#SBATCH --error="run1_no_pressure_%j.err"
...
CHECKPOINT_ROOT="checkpoints/compositional-run1-no-pressure"
OUTDIR="docs/figures/run1_no_pressure"
...
echo "Training Run 1 without pressure using $CONFIG"
...
echo "Run 1 complete. Checkpoint: $CHECKPOINT"
echo "Figures: $OUTDIR"
