...
#SBATCH --job-name="cls-r5-nop"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run5_no_pressure_%j.out"
#SBATCH --error="run5_no_pressure_%j.err"
...
CONFIG="configs/compositional/run5_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run5-no-pressure"
OUTDIR="docs/figures/run5_no_pressure"
...
echo "Training Run 5 without pressure using $CONFIG"
...
echo "Run 5 complete. Checkpoint: $CHECKPOINT"
echo "Figures: $OUTDIR"
