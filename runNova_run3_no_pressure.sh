...
#SBATCH --job-name="cls-r3-nop"
#SBATCH --mail-user=haydenc1@iastate.edu
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --output="run3_no_pressure_%j.out"
#SBATCH --error="run3_no_pressure_%j.err"
...
CONFIG="configs/compositional/run3_no_pressure.yaml"
CHECKPOINT_ROOT="checkpoints/compositional-run3-no-pressure"
OUTDIR="docs/figures/run3_no_pressure"
...
echo "Training Run 3 without pressure using $CONFIG"
...
echo "Run 3 complete. Checkpoint: $CHECKPOINT"
echo "Figures: $OUTDIR"
